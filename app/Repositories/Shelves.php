...
{
    private Shelf $model;
    public static function init(Shelf $model): Shelves
    {
        $instance = new self;
    ...
    public static function store(object $data): Shelf
    {
        $model = new Shelf((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Shelf
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Shelf $model) {
                $actions = '';
